...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">StockQty</label><p className="m-0 ml-3" >{Number(_entity?.stockQty)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">SupplierId</label><p className="m-0 ml-3" >{_entity?.supplierId}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">SupermarketId</label><p className="m-0 ml-3" >{_entity?.supermarketId}</p></div>
