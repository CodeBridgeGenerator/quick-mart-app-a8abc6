...
import seederData from "./orderItem.seeder.json";
...
const OrderItemSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(OrderItemSeederDialogComponent);
