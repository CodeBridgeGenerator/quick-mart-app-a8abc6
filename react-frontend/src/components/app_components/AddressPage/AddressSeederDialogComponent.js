...
import seederData from "./address.seeder.json";
...
const AddressSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AddressSeederDialogComponent);
