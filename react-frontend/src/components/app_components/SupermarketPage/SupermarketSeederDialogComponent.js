...
import seederData from "./supermarket.seeder.json";
...
const SupermarketSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SupermarketSeederDialogComponent);
