...
import pic1 from "../../assets/media/pic-3.png";
import pic2 from "../../assets/media/pic-2.png";
  ...
  return (
    <div className="flex flex-col min-h-screen align-items-center justify-content-center background-image">
      ...
      <div className="absolute bottom-0 left-0 flex justify-between w-full px-10 py-10 z-[-1]">
        <img src={pic1} alt="pic1" className="w-20rem min-w-[150px]" />
        <img src={pic2} alt="pic2" className="w-20rem min-w-[150px]" />
      </div>
      <AppFooter />
    </div>
  );
